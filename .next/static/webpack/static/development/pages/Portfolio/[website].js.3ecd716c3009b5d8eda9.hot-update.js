...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(About, [{
    ...
    value: function check(web) {
      if (web == 'websites' || web == 'Websites') {
        return {
          ...
          data: _profile_json__WEBPACK_IMPORTED_MODULE_14__.list.website
        };
      } else if (web == 'mobileApps' || web == 'Apps') {
        return {
          name: 'Native Mobile Apps',
          desc: 'Android So far That i am allowed to list',
          data: _profile_json__WEBPACK_IMPORTED_MODULE_14__.list.mobileapp
        };
      }
    }
  }, {
    ...
    value: function render() {
      console.log(_profile_json__WEBPACK_IMPORTED_MODULE_14__.list);
      return __jsx("div", {
        __source: {
...
//# sourceMappingURL=[website].js.3ecd716c3009b5d8eda9.hot-update.js.map